...
NM-UsrA@1520-B-2510-Bank-1> ...ra    ti
NM-UsrA@1520-B-2510-Bank-1> ...io    n 
NM-UsrA@1520-B-2510-Bank-1> ... |     d
NM-UsrA@1520-B-2510-Bank-1> ...di    sp
NM-UsrA@1520-B-2510-Bank-1> ...pl    ay
NM-UsrA@1520-B-2510-Bank-1> ...y     se
NM-UsrA@1520-B-2510-Bank-1> ...et     |
NM-UsrA@1520-B-2510-Bank-1> ...|     no
NM-UsrA@1520-B-2510-Bank-1> ...o-    tests.MO
NM-UsrA@1520-B-2510-Bank-1> ...or    e
set services service-set szt1-nat nat-rules szt1-input
set services service-set szt1-nat nat-rules szt1-output
NM-UsrA@1520-B-2510-Bank-1>`,
...
`,
		...
		{data: ` show configu
NM-UsrA@1527-B-2510-2> ...ation | d
NM-UsrA@1527-B-2510-2> ...splay set
NM-UsrA@1527-B-2510-2> ...| no-more
NM-UsrA@1527-B-2510-2> ...
set version 9.3R4.4
set system host-name 1527-B-2510-2
set system time-zone Asia/Shanghai
set firewall filter 49-BJ-CW-OUTBOUND term 1 from source-prefix-list 89
set firewall filter 49-BJ-CW-OUTBOUND term 1 then accept
NM-UsrA@1527-B-2510-2>`,
...
set system host-name 1527-B-2510-2
set system time-zone Asia/Shanghai
-- more -- set firewall filter 49-BJ-CW-OUTBOUND term 1 from source-prefix-list 89
set firewall filter 49-BJ-CW-OUTBOUND term 1 then accept
NM-UsrA@1527-B-2510-2>`,
			result: `set version 9.3R4.4
set system host-name 1527-B-2510-2
...
set system host-name 1527-B-2510-2
set system time-zone Asia/Shanghai
-- more -- ssset firewall filter 49-BJ-CW-OUTBOUND term 1 from source-prefix-list 89
set firewall filter 49-BJ-CW-OUTBOUND term 1 then accept
NM-UsrA@1527-B-2510-2>`,
			result: `set version 9.3R4.4
set system host-name 1527-B-2510-2
...
var raw_chars = []byte(`11521-C-2950-BankOUT#sh run
Building configuration...
...
var rs_chars = []byte(`11521-C-2950-BankOUT#sh run
Building configuration...
clock timezone ShangHai 8
ip subnet-zero
no ip source-route
